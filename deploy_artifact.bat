...
if not defined VITE_GITHUB_REDIRECT_URI set "VITE_GITHUB_REDIRECT_URI=https://edupivot.xyz/oauth/github/callback"
if not defined VITE_MOBILE_GITHUB_REDIRECT_URI set "VITE_MOBILE_GITHUB_REDIRECT_URI=https://edupivot.xyz/oauth/github/mobile/callback"
