...
.header-info h1 { margin: 0 0 8px; font-family: var(--font-heading); font-size: 36px; font-weight: 600; color: var(--color-on-surface); }
...
.btn-primary, .btn-secondary { display: inline-flex; align-items: center; gap: 6px; padding: 10px 20px; border: none; border-radius: var(--radius-sm); font-family: var(--font-body); font-size: 13px; font-weight: 600; cursor: pointer; }
