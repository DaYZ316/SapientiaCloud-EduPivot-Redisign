  ...
  <div ref="previewPageRef" class="file-preview-page">
    ...
    <main class="preview-content">
      ...
      <div v-else-if="error" class="preview-status">
        ...
        <p>{{ error }}</p>
        <button v-if="fileUrl" :disabled="downloading" class="btn-primary" @click="downloadFile">
      ...
      <div v-else-if="fileCategory === 'image'" class="image-container">
        <img :alt="fileName" :src="fileUrl" @error="handleLoadError"/>
      </div>

      <!-- Video -->
      <div v-else-if="fileCategory === 'video'" class="media-container">
        <video :src="fileUrl" controls @error="handleLoadError">
      ...
      <div v-else-if="fileCategory === 'audio'" class="media-container">
        <div class="audio-wrapper">
          ...
          <audio :src="fileUrl" controls @error="handleLoadError">
            {{ t('filePreview.unsupported') }}
          </audio>
        </div>
      </div>
