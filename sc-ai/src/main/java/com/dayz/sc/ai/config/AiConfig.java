...
public class AiConfig {
    ...
    @Bean
    public OpenAiHttpClientBuilderCustomizer openAiHttpClientTimeoutCustomizer(AiProperties aiProperties) {
        return builder -> builder.timeout(aiProperties.getGeneration().getProviderTimeout());
    }
