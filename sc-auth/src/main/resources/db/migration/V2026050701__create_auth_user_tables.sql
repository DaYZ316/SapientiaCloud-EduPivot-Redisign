...
(
    ...
    last_login_at TIMESTAMPTZ,
    CONSTRAINT fk_auth_user_identities_user FOREIGN KEY (user_id) REFERENCES auth_users(id) ON DELETE CASCADE,
    CONSTRAINT uk_auth_user_identities_provider_user UNIQUE (provider, provider_user_id)
);
