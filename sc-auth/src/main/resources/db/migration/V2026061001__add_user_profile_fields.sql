...
-- 注释
COMMENT ON COLUMN auth_users.phone IS '电话号码';
COMMENT ON COLUMN auth_users.bio IS '个人简介';
COMMENT ON COLUMN auth_users.gender IS '性别: 0=未知, 1=男, 2=女';
COMMENT ON COLUMN auth_users.birthday IS '生日';
COMMENT ON COLUMN auth_users.theme IS '主题偏好: light, dark, system';
COMMENT ON COLUMN auth_users.notification_enabled IS '是否开启通知';
