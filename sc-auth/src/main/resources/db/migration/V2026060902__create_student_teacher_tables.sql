...
COMMENT ON TABLE edu_student IS '学生信息表';
COMMENT ON TABLE edu_teacher IS '教师信息表';

COMMENT ON COLUMN edu_student.student_no IS '学号';
COMMENT ON COLUMN edu_student.grade IS '年级';
COMMENT ON COLUMN edu_student.major IS '专业';
COMMENT ON COLUMN edu_student.school IS '学校';

COMMENT ON COLUMN edu_teacher.employee_no IS '工号';
COMMENT ON COLUMN edu_teacher.department IS '院系';
COMMENT ON COLUMN edu_teacher.title IS '职称';
COMMENT ON COLUMN edu_teacher.school IS '学校';
